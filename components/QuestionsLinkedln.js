        ...
        <div className="bg-bg2 flex flex-col justify-center items-center px-24 py-40 text-bg12 gap-12">
            ...
            <div className="flex flex-col gap-4 justify-center w-[70%] relative">
                ...
                <div className="bg-red-950 cursor-pointer px-12 py-12 rounded-3xl relative hover:outline hover:outline-red-950 hover:outline-offset-2">
                    {openQuestion2 ? (<div>
                        <span className="text-2xl font-bold"> What is Linktree used for on Linkedln?
                        </span >
                        <div className='mt-12 text-lg font-semibold'>
                    ...
                    </div>) : (<span className="text-2xl font-bold"> What is Linktree used for on Linkedln?
                    </span >)}
                ...
                <div className="bg-red-950 cursor-pointer px-12 py-12 rounded-3xl relative hover:outline hover:outline-red-950 hover:outline-offset-2">
                    {openQuestion3 ? (<div>
                        <span className="text-2xl font-bold">Can I use my Linktree on Linkedln?
                        </span >
                        <div className='mt-12 text-lg font-semibold'>
                    ...
                    </div>) : (<span className="text-2xl font-bold">Can I use my Linktree on Linkedln?
                    </span >)}
                ...
                <div className="bg-red-950 cursor-pointer px-12 py-12 rounded-3xl relative hover:outline hover:outline-red-950 hover:outline-offset-2">
                    {openQuestion4 ? (<div>
                        <span className="text-2xl font-bold">What is LinkedIn Creator Mode?
                        </span >
                        <div className='mt-12 text-lg font-semibold'>
                            <p>{`Creator mode is a profile setting on your dashboard that can help you grow your reach and influence on LinkedIn. You can turn on creator mode to get access to additional tools and features that help you create content and grow your audience base on LinkedIn*. By adding a unique Linktree URL, you supercharge an already powerful tool.`}</p>
                            <p className='mt-8'>{`*From LinkedIn Support website`}</p>
                        </div>
                    </div>) : (<span className="text-2xl font-bold">What is LinkedIn Creator Mode?
                    </span >)}
                ...
                <div className="bg-red-950 cursor-pointer px-12 py-12 rounded-3xl relative hover:outline hover:outline-red-950 hover:outline-offset-2">
                    {openQuestion5 ? (<div>
                        <span className="text-2xl font-bold">Do I need to pay for LinkedIn Creator Mode?
                        </span >
                        <div className='mt-12 text-lg font-semibold'>
                            <p>{`No, it is totally free!`}</p>
                        </div>
                    </div>) : (<span className="text-2xl font-bold">Do I need to pay for LinkedIn Creator Mode?
                    </span >)}
