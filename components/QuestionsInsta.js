        ...
        <div className="bg-bg2 flex flex-col justify-center items-center px-24 py-40 text-bg12 gap-12">
            ...
            <div className="flex flex-col gap-4 justify-center w-[70%] relative">
                <div className="bg-red-950 px-12 py-12 rounded-3xl cursor-pointer  hover:outline hover:outline-red-950 hover:outline-offset-2">
                    {openQuestion1 ? (<div>
                        ...
                        <div className='mt-12 text-lg font-semibold'>
                            ...
                            <p className='mt-8'>“Linktree solves the most obvious problem a majority of creators have had by allowing them to promote ALL of their platforms, products, services, etc in the same link.” – <a className='underline'>@rileydoingthings</a></p>
                        </div>
                ...
                <div className="bg-red-950 cursor-pointer px-12 py-12 rounded-3xl relative hover:outline hover:outline-red-950 hover:outline-offset-2">
                    {openQuestion2 ? (<div>
                        <span className="text-2xl font-bold"> What is Linktree used for on Instagram?
                        </span >
                        <div className='mt-12 text-lg font-semibold'>
                            <p>{`Linktree is a platform that enables you to share more than one link from your IG bio. People use it on social media, email signatures, video descriptions, show notes, live streams, webinars and even offline, using QR codes to connect people to your online identity.`}</p>
                            <p className='mt-8'>{`“It’s a wonderful way to direct traffic to what matters.” – Grem`}</p>
                        </div>
                    </div>) : (<span className="text-2xl font-bold"> What is Linktree used for on Instagram?
                    </span >)}
                ...
                <div className="bg-red-950 cursor-pointer px-12 py-12 rounded-3xl relative hover:outline hover:outline-red-950 hover:outline-offset-2">
                    {openQuestion3 ? (<div>
                        <span className="text-2xl font-bold">Can I use my Linktree just on IG or also on my other social media platforms?
                        </span >
                        <div className='mt-12 text-lg font-semibold'>
                            <p>{`Absolutely! You can use your Linktree bio link on your TikTok profile, Facebook page, YouTube channel, Twitter, etc. There is no limit on how many times you can share your unique link. You can use your link in bio link everywhere you want to connect and engage with your fans and followers.`}</p>
                        </div>
                    </div>) : (<span className="text-2xl font-bold">Can I use my Linktree just on IG or also on my other social media platforms?
                    </span >)}
                ...
                <div className="bg-red-950 cursor-pointer px-12 py-12 rounded-3xl relative hover:outline hover:outline-red-950 hover:outline-offset-2">
                    {openQuestion7 ? (<div>
                        ...
                        <div className='mt-12 text-lg font-semibold'>
                            ...
                            <p className='my-8'>“I hardly touch my website any more. I just send people to my Linktree! It’s a good-looking, fresh interface… so much more dynamic. I can take a few minutes, update my links and put my phone away rather than spending 45 struggling on WordPress.” –<a className='underline'> @ashleyhopeperez</a></p>
                        </div>
