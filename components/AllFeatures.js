...
const AllFeatures = () => {
  ...
  return (
    <div >
      <div className='flex items-center w-[70%] ml-[30%] bg-customLight justify-start pr-12 sticky top-0  z-100 ' >
      ...
      <div className='flex '>
        <div id="list-example" className="list-group w-[30%] bg-customLight  text-lg flex flex-col items-center gap-10">
          <a className=" cursor-pointer list-group-item-action" href="#list-item-1">Link & Buttons</a>
          <a className="cursor-pointer list-group-item-action" href="#list-item-2">Monetization</a>
          <a className="cursor-pointer list-group-item-action " href="#list-item-3">Customization</a>
          <a className="cursor-pointer list-group-item-action" href="#list-item-4">Marketing Tech</a>
          <a className="cursor-pointer list-group-item-action " href="#list-item-5">Management</a>
        </div>

        <div className='scrollspy-example overflow-y-scroll max-h-screen w-full' data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0" tabIndex="0">
          <div className='bg-white w-full  mx-auto rounded-3xl' id="list-item-1">
            <ul>
          ...
          <div className='bg-white w-full mx-auto rounded-3xl my-20' id="list-item-2">
            <ul>
          ...
          <div className='bg-white w-full mx-auto rounded-3xl' id="list-item-3">
            <ul>
          ...
          <div className='bg-white w-full mx-auto rounded-3xl my-20' id="list-item-4">
            <ul>
          ...
          <div className='bg-white w-full mx-auto rounded-3xl' id="list-item-5">
            <ul>
