    ...
    <nav className='h-20 mt-12 mx-20 rounded-full flex justify-between pr-4 pl-10 items-center navbar sticky bg-white top-12'>
      <div className='flex gap-14 items-center'>
        ...
        <ul className='flex gap-2 text-textcolor font-semibold'>
          ...
          <Link href=""><li className='cursor-pointer hover:bg-customLight px-3 py-2 hover:rounded-lg'>Pricing</li></Link>
          <div className='relative group '>
            <Link href=""><li className='cursor-pointer hover:bg-customLight px-3 py-2 hover:rounded-lg'>Learn</li></Link>
