        ...
        <div className='h-[55vh]'>
            ...
            >
                <SwiperSlide className='w-[300px] ml-28 -mr-16'>
                    <div className='w-[300px] rounded-full flex items-center justify-center h-[55vh] flip-card'>
                ...
                <SwiperSlide className='w-[300px] -mr-16'>
                    <div className='w-[300px] rounded-xl flip-card flex items-center justify-center h-[55vh]'>
                        <div className='flip-card-inner '>
                ...
                <SwiperSlide className='w-[480px] mr-28 '>
                    <div className='w-[480px] rounded-3xl h-[55vh] roundedP flip-card'>
                        <div className='flip-card-inner'>
                            <div className='flip-card-front'>
                ...
                <SwiperSlide className='w-[300px] -mr-16 ml-1'>
                    <div className='w-[300px]  rounded-full hover: relative hover:flex hover:justify-center hover:items-center group h-[55vh] flip-card'>
                        <div className='flip-card-inner'>
                ...
                <SwiperSlide className='w-[480px] mr-28 '>
                    <div className='w-[480px] rounded-3xl h-[55vh] flip-card'>
                        <div className='flip-card-inner'>
                            <div className='flip-card-front'>
                ...
                <SwiperSlide className='w-[300px] ml-1 mr-12'>
                    <div className='w-[300px] rounded-xl flip-card h-[55vh]'>
                        <div className='flip-card-inner'>
                            <div className='flip-card-front'>
                ...
                <SwiperSlide className='w-[480px]  -ml-28 mr-1'>
                    <div className='w-[480px] roundedP h-[55vh] flip-card'>
                        <div className='flip-card-inner'>
                            <div className='flip-card-front'>
